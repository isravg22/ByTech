          ...
          {smartphones.map((smartphone) => (
            ...
            >
              ...
              <div className="w-full text-left">
                <h2 className="text-lg font-bold mb-2 text-gray-800">{smartphone.name.toUpperCase()}</h2>
                ...
                <p className="text-blue-600 font-semibold text-base mb-4">Precio: {smartphone.price}€</p>
                <button
                  onClick={() => handleDetailClick(smartphone.id)}
                  className="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition font-medium"
                >
                  <Link href={`/Smartphone/details/`}>
                    Ver detalles
                  </Link>
                </button>
              </div>
