...
export default function Login({ navigation }: any) {
    ...
    const goHome = async () => {
        try {
            const response = await fetch('http://192.168.0.27:8001/user/login', {
                method: 'POST',
                headers: {
    ...
    return (
        ...
        <ScrollView style={{backgroundColor: '#00C8E6'}}>
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                <View style={{ backgroundColor: 'white', padding: 20, borderRadius: 20, width: '80%',marginTop:'9%',marginBottom:'9%'}}>
