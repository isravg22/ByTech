 ...
 const getProducts = async () => {
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <h1 style={{ marginBottom: '20px', textAlign: 'center' }}>Productos Disponibles</h1>
        ...
        {products.map((product) => (
          <div key={product.id} style={{ padding: '20px', marginBottom: '40px', border: '1px solid #ccc', borderRadius: '8px', backgroundColor: '#fff', textAlign: 'center', width: '300px' }}>
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <p style={{ margin: '0 0 10px 0', fontSize: '1rem', minHeight: '30px' }}>Descripción: {product.description}</p>
